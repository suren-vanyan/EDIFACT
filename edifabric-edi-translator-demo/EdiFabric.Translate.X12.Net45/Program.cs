...
namespace EdiFabric.Translate.X12.Net45
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var reader = new X12Reader(File.OpenRead(Directory.GetCurrentDirectory() + @"\..\..\Edi.BookingConfirmation.3627746.txt"), "EdiFabric.Templates.X12", new X12ReaderSettings { ContinueOnError = true }))
